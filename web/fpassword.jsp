    ...
    <body>
        <div class="d1">
            ...
            <div class="d2">
                ...
                <div class="i_mod">
                    <form action="fpasswC.jsp" name="form1" onsubmit="return mycheck()">
                        <p>
                            <span class="tit">ID</span><input type="text" name="tuid" id="ttuid" placeholder="Please enter valid ID" value="<%=request.getParameter("pass")%>">
                        </p>
                        <p> 
