            ...
            <div class="g-wrap">
                <div class="header-nav">
                    <ul>
                        ...
                        <li class="pipe">|</li>
                        <li><a class="curr" href="javascript:void(0);">Clerk Management </a></li>
                    </ul>
                </div>
                <div>
                ...
                <div class="g-body-mod pro-advantage-mod" style="background-image:url(image/body_bg.jpg) ">
                    <div class="g-wrap">
                        <div class="g-main" style="margin-left: 220px">
                            <form action="admin3C.jsp"  name="form1" onsubmit="return myCheck()">
                                <p>
                                    <label>ID</label>
                                ...
                                <p>
                                    <label>Address</label>
                                    <input type="text" class="in" name="taddress">
                                </p>
                                <br>
                                <p>
...
//                                    rs.absolute(0); //Sql server
                                    ...
                                    while(rs.next())
                                    {
                                        user[m]=rs.getString("clerk_id");
                                        m++;
                                    }
                                %>
                                <form action="admin3C1.jsp" name="form2" onsubmit="return myCheck1()">
                                    <p>
                                        <label>ID</label>
                                    ...
                                    <p>
                                     ...
                                     <p>
                                        <label>Address</label>
                                        <input type="text" class="in" name="taddress1">
                                    </p>
                                    <br>
                                    <p>
                              ...
                              <!--点击Details 反馈-->
                                <%
                                    ...
                                    if(sid2=="null"||sid2==null)
                                        sid2="";
                                    query1="select * from clerk where clerk_id=?";
                                    ...
                                    {
                                %>      
                                    <form action="admin3C2.jsp">
                                       <div style=" display: none;margin-left: 30px;" id="divDe">
                                           <p>
                                               <label>Name:</label><span class="span1" style=" margin-left: 80px"><%=rs1.getString("clerk_name")%></span>
                                               <input type="text" hidden name="tid2" value="<%=sid2%>">
                                           </p>
                                           <p>
                                               <label>Phone:</label><span class="span1" style=" margin-left: 76px"><%=rs1.getString("clerk_phone")%></span>
                                           </p>
                                           <p>
                                               <label>Gender:</label><span class="span1" style=" margin-left: 71px"><%=rs1.getString("clerk_gender")%></span>
                                           </p>
                                           <p>
                                               <label>Address:</label><span class="span1" style=" margin-left:66px"><%=rs1.getString("clerk_address")%></span>
                                           </p>
                                           <p>
                            ...
                            <form action="cidgo1.jsp">
                                ...
                                <%
                                    ...
                                    if(sid3=="null"||sid3==null)
                                        sid3="";
                                    query2="select * from clerk where clerk_id=?";
                                ...
                                %>
                                    <div style=" display: none;margin-left: 30px;" id="divView">
                                        <p>
                                            <label>Name:</label><span class="span1" style=" margin-left: 80px"><%=rs2.getString("clerk_name")%></span>
                                        </p>
                                        <p>
                                            <label>Phone:</label><span class="span1" style=" margin-left: 76px"><%=rs2.getString("clerk_phone")%></span>
                                        </p>
                                        <p>
                                            <label>Gender:</label><span class="span1" style=" margin-left: 71px"><%=rs2.getString("clerk_gender")%></span>
                                        </p>
                                        <p>
                                            <label>Address:</label><span class="span1" style=" margin-left:66px"><%=rs2.getString("clerk_address")%></span>
                                        </p>
                                    </div>
                            <%
                                }
            ...
            <div class="g-sidebar">
                <ul class="lift-wrapper">
                    <li><a href="javascript:void(0)" class="lift-emit" style="width:150px">Add Clerk<i class="ico-state"></i></a></li>
                    <li><a href="javascript:void(0)" class="lift-emit" style="width:150px">Update Clerk<i class="ico-state"></i></a></li>
                    <li><a href="javascript:void(0)" class="lift-emit" style="width:150px">Delete Clerk<i class="ico-state"></i></a></li>
                    <li><a href="javascript:void(0)" class="lift-emit on" style="width:150px">View Clerk<i class="ico-state"></i></a></li>
                </ul>
            </div>
            <div class="footer">
                <p>
    ...
    <script>
        ...
        if(same=="yes")
        {
            alert("This Clerk ID has been uesed,please use other id...");
