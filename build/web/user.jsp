        ...
        <div class="g-content">
            <div class="g-body g-pro-body">
                <div class="g-body-mod pro-advantage-mod" style="background-image:url(image/body_bg.jpg);">
                    <div class="g-wrap">
                        <div class="g-main" style="margin-left: 220px">
                            ...
                            %>
                                <p>
                                    <label>Name</label><span class="span1" style=" margin-left: 100px"><%=rs.getString("user_name")%></span>
                                </p>
                                <p>
                                    <label>Phone</label><span class="span1" style=" margin-left: 95px"><%=rs.getString("user_phone")%></span>
                                </p>
                                <p>
                                    <label>Class</label><span class="span1" style=" margin-left: 105px"><%=rs.getString("user_class")%></span>
                                </p>
                                <p>
                                    <label>Role</label><span class="span1"style=" margin-left: 109px"><%=rs.getString("user_role")%></span>
                                </p>
                                <p>
                                    <label>Department</label><span class="span1" style=" margin-left: 56px"><%=rs.getString("user_depart")%></span>
                                </p>
                                <%
                                    }
                                    }
                ...
                <div class="g-body-mod pro-advantage-mod">
                    <div class="g-wrap">
                        <div class="g-main" style="margin-left: 220px">
                             <form action="user1C.jsp" name="form1" onsubmit="return myCheck()">
                                <p>
